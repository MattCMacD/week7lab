...
public class NoteDB {
    ...
    public int insert(Note note) throws NotesDBException {
        ...
        try {
            ...
            String preparedQuery = "INSERT INTO Note (dateCreated, content) VALUES (?, ?)"; //start the query
    ...
    public List<Note> getAll() throws NotesDBException {
        ...
        try {
            ...
            while (rs.next()) {
                notes.add(new Note(rs.getInt("noteId"), toJavaDate(rs.getDate("dateCreated")), rs.getString("content")));
            }
    ...
    public Note getNote(int noteId) throws NotesDBException {
        ...
        try {
            ...
            while (rs.next()) {
                note = new Note(rs.getInt("noteId"), toJavaDate(rs.getDate("dateCreated")), rs.getString("content"));
            }
